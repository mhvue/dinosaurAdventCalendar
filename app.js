...
const dinosaurFacts = [
    ...
    "Theropods means beast foot. It is a group of dinosaurs that has three toes for each leg and very short arms. For example: T-Rex",
    ...
    "Joke: What did the dinosaur say when the volacano exploded?....." + "<br> Answer: Have a Lava-ly day!",
    ...
    "Fossils are remains of ancient animals. It helps us learn about them. Here is the Heterodontonsaurus fossil" + imgs.dino7,
    "Herbivores means eating plants. Carnivore meants eating plants. Omnivore means eating meat and plants. Most dinosaures were herbivore.",
    ...
    "Did dinosaur lay eggs?" + "<br> Yes they did!",
